 ...
 * @generated
 */
public class FriendzGMFWithoutLikeDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public FriendzGMFWithoutLikeDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof FriendzGMFWithoutLikeDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((FriendzGMFWithoutLikeDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new FriendzGMFWithoutLikeDomainNavigatorItem(
