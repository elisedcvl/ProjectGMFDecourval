 ...
 * @generated
 */
public class AuthorshipReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AuthorshipReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Authorship) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		Publication target = getLink().getPubli();
		...
		return FriendzGMFWithoutLikeBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistAuthorship_4001(container,
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getLink().setAuthor(getNewSource());
	 ...
	 * @generated
	 */
	protected Authorship getLink() {
		return (Authorship) getElementToEdit();
	}
