 ...
 * @generated
 */
public class UserFirstNameLastNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public UserFirstNameLastNameEditPart(View view) {
		super(view);
	}
			...
			parser = FriendzGMFWithoutLikeParserProvider
					.getParser(
							...
							FriendzGMFWithoutLikeVisualIDRegistry
									.getType(friendz.diagram.edit.parts.UserFirstNameLastNameEditPart.VISUAL_ID));
		}
		return parser;
	}
