 ...
 * @generated
 */
public class EnemityNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				...
				.getType(friendz.diagram.edit.parts.EnemityNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public EnemityNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new friendz.diagram.edit.policies.FriendzGMFWithoutLikeTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = friendz.diagram.providers.FriendzGMFWithoutLikeParserProvider
					.getParser(
							friendz.diagram.providers.FriendzGMFWithoutLikeElementTypes.Enemity_4004,
							getParserElement(),
							friendz.diagram.part.FriendzGMFWithoutLikeVisualIDRegistry
									.getType(friendz.diagram.edit.parts.EnemityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					friendz.diagram.edit.parts.FriendzGMFWithoutLikeEditPartFactory
