 ...
 * @generated
 */
public class FriendzGMFWithoutLikeInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new FriendzGMFWithoutLikeNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				FriendzEditPart.MODEL_ID));
		FriendzGMFWithoutLikeDiagramEditorUtil.runWizard(getShell(), wizard,
