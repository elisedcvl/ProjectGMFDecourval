...
import friendz.diagram.edit.policies.FriendzGMFWithoutLikeTextSelectionEditPolicy;
 ...
 * @generated
 */
public class PublicationPublicationEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PublicationPublicationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new FriendzGMFWithoutLikeTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return FriendzGMFWithoutLikeElementTypes.getImage(parserElement
				.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FriendzGMFWithoutLikeParserProvider
					.getParser(
							FriendzGMFWithoutLikeElementTypes.Publication_2002,
							getParserElement(),
							FriendzGMFWithoutLikeVisualIDRegistry
									.getType(friendz.diagram.edit.parts.PublicationPublicationEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					FriendzGMFWithoutLikeEditPartFactory
