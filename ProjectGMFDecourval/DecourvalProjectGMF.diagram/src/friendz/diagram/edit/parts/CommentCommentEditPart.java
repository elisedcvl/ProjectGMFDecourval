 ...
 * @generated
 */
public class CommentCommentEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CommentCommentEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FriendzGMFWithoutLikeParserProvider
					.getParser(
							FriendzGMFWithoutLikeElementTypes.Comment_2003,
							getParserElement(),
							FriendzGMFWithoutLikeVisualIDRegistry
									.getType(friendz.diagram.edit.parts.CommentCommentEditPart.VISUAL_ID));
		}
		return parser;
	}
