...
import friendz.diagram.part.FriendzGMFWithoutLikeDiagramEditor;
 ...
 * @generated
 */
public class FriendzGMFWithoutLikeNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof FriendzGMFWithoutLikeNavigatorItem) {
					selectedElement = ((FriendzGMFWithoutLikeNavigatorItem) selectedElement)
							.getView();
